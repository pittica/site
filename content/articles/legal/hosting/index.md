...
## Responsabilità e Obblighi del Cliente
...
## Garanzia di funzionamento (Service Level Agreement)

1.  Qualsiasi fornitura di hosting o traffico dati, fornito o mediato da Pittica, è selezionato da Pittica per una continuità di 24 ore su 24 senza interruzioni.
2.  Il Cliente accetta che Pittica potrà sospendere il Servizio in caso di manutenzione straordinaria od ordinaria, in linea con le necessità interne o del fornitore di infrastruttura.
3.  Il livello di performance del Servizio è dipendente dal piano concordato con il Cliente. Pittica fornirà, se richiesto dal Cliente, il Service Level Agreement (SLA) del proprio fornitore di infrastruttura in proprio possesso.
4.  Pittica garantisce tempi di risposta in base alla gravità del problema.
    I livelli di gravità sono i seguenti:
    -   **Alta**: Il Servizio è inaccessibile
    -   **Media**: Il Servizio sotto presenta problemi di performance o sono emessi errori.
    -   **Bassa**: Il Servizio presenta problematiche ignote o che non compromettono in alcun modo il funzionamento.
5.  In caso di ritardi nella risposta superiori alle 24 ore, Pittica rimborserà il 25% del canone annuale concordato.
6.  I rimborsi complessivi in un anno non potranno superare la totalità del costo del piano.
7.  Il Cliente potrà richiedere rimborsi entro e non oltre 7 giorni dal verificarsi della inacessibilità all'indirizzo PEC [pitticasrls@pec.it](mailto:pitticasrls@pec.it).

## Clausola risolutiva

1.  Il presente contratto si intende automaticamente risolto ai sensi dell'art. 1456 del codice civile per inadempimento anche di una sola delle obbligazioni previste a carico del Cliente.

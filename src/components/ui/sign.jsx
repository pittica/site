...
export default function Sign({ color, width, height }) {
  return (
    ...
    >
      ...
      />
      <path
        className={classNames("sign-pittica-icon", "sign-icon-1")}
        fill={color}
      ...
      />
      <path
        className={classNames("sign-pittica-icon", "sign-icon-2")}
        fill={color}
      ...
      />
      <path
        className={classNames("sign-pittica-icon", "sign-icon-3")}
        fill={color}
